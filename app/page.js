...
// // import { useRouter } from "next/navigation";
// // import HomePageHeader from "@/component/HomePageHeader";
// // import { Routes } from "@/config/routes"; // Adjust or remove if not using a config file

// // // IMPORTANT: Replace this with an actual image of your furniture/woodwork
...
// //   return (
// //     <div className="h-full flex flex-col bg-white w-full overflow-hidden text-[#1a1a1a]">

// //       <HomePageHeader />

// //       <main className="flex-1 flex items-center justify-center relative w-full pt-24 pb-12">

// //         {/* =========================================
// //             MOBILE LAYOUT (Visible only on small screens)
// //             ========================================= */}
// //         <div className="md:hidden flex flex-col items-center text-center px-4 w-full z-10 mt-10">
// //           <span className="text-sm font-semibold tracking-widest uppercase text-gray-500 mb-2">
// //             Handcrafted
// //           </span>
// //           <h1 className="text-6xl font-black uppercase tracking-tighter leading-none mb-6 text-black">
// //             Wood <br /> Design
// //           </h1>

// //           <div className="relative w-full max-w-[320px] aspect-[3/4] rounded-[2rem] shadow-2xl mb-8">
// //             <Image
...
// //               priority
// //             />
// //             <button className="absolute -bottom-6 -right-6 w-24 h-24 bg-[#2a2a2a] text-white rounded-full flex items-center justify-center text-xl font-medium shadow-xl hover:scale-105 transition-transform">
// //               Shop
// //             </button>
// //           </div>

// //           <p className="text-gray-500 text-base leading-relaxed px-4">
// //             Premium, sustainable wood furniture elevating your living spaces. Custom crafted with elegance.
// //           </p>
// //         </div>

// //         {/* =========================================
// //             DESKTOP LAYOUT (Editorial Spread)
// //             ========================================= */}
// //         <div className="hidden md:flex max-w-[1400px] w-full h-[75vh] min-h-[600px] relative items-center justify-center mx-auto px-8">

// //           {/* Left Text Block */}
// //           <div className="absolute left-8 lg:left-16 xl:left-24 z-0 flex flex-col justify-center translate-y-[-20px]">
// //             <span className="text-sm md:text-base font-semibold tracking-[0.2em] uppercase text-gray-500 mb-2 pl-2">
// //               Artisanal Craft
// //             </span>
// //             <h1 className="text-[12vw] xl:text-[160px] font-black uppercase leading-none tracking-tighter text-[#1a1a1a]">
// //               WOOD
// //             </h1>
// //           </div>

// //           {/* Center Image Container */}
// //         <div className="relative z-10 w-[80%] max-w-[280px] md:max-w-[340px] lg:max-w-[400px] aspect-[4/5] mx-auto">
// //   {/* The Image */}
// //   <div className="w-full h-full relative rounded-[2rem] lg:rounded-[2.5rem] shadow-2xl overflow-hidden bg-gray-100">
// //     <Image
// //       src={heroFurnitureImage}
// //       alt="Handcrafted Wood Furniture"
// //       fill
...
// //           {/* Right Text Block */}
// //           <div className="absolute right-8 lg:right-16 xl:right-24 z-0 flex flex-col items-end translate-y-[40px]">
// //             <h1 className="text-[12vw] xl:text-[160px] font-black uppercase leading-none tracking-tighter text-[#1a1a1a]">
// //               ART
// //             </h1>
// //             <p className="mt-4 text-gray-500 text-lg lg:text-xl leading-relaxed text-right max-w-xs xl:max-w-sm pr-2">
// //               Sustainable, premium wood furniture designed to elevate your living spaces.
// //             </p>
// //           </div>

// //           {/* Bottom Right Floating Widget (Matching "New release") */}


// //         </div>

// //         {/* Bottom Center Scroll Indicator (Matching the toggle at the bottom of the image) */}
// //         <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex justify-center w-full md:hidden">
// //             <div className="w-12 h-6 rounded-full border-2 border-gray-300 flex items-center justify-start p-1">
