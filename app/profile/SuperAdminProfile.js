...
import { useEditSuperAdminProfile } from "@/helpers/hooks/mamAdmin/mamAdmin";
...
const SuperAdminProfile = () => {
  ...
  const { mutate: editsuperadminprofile, isPending } =
    useEditSuperAdminProfile();
  ...
  const onSubmit = (formData) => {
    ...
    editsuperadminprofile(formdata, {
      onSuccess: (res) => {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Box display="flex" justifyContent="center" mb={3}>
              {role === "super_admin" && (
                ...
                //       alt="user-profile"
                //       fill
                //       className="object-cover rounded-full border-[2px]"
                //     />
                //   </div>
