...
import ActivePlanTab from "./ActivePlanTab";
import BillingTab from "./BillingTab";
import BrowsePlansTab from "./BrowsePlansTab";
import PaymentProcessor from "./PaymentProcessor";
import { errorNotification } from "@/helpers/notification";
const TrainerSubscriptionPlans = () => {
  ...
  const { data, isPending:isFetching, refetch } = useGetStripePlanByTrainer({
    enabled: true,
  });
  const {
    mutate: purchasePlan,
  ...
  const handlePayNow = (
    ...
    const apiToCall = upgradePlan && subscriptionData.current_subscription !== null ? upgradeSubscriptionPlan : purchasePlan;
    apiToCall(payload, {
      onSuccess: (response) => {
        ...
        >
          ...
          >
            ...
            <Tab
              ...
              iconPosition="start"
            />
            <Tab label="Billing" icon={<ReceiptIcon />} iconPosition="start" />
          </Tabs>
