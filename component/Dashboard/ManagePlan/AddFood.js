...
const {
  ...
  type: typeOption ? [typeOption] : ["food"],
  enabled: activeTab === 2,
  limit: 10,
});
          ...
          <div className="flex flex-col h-full">
            ...
            {activeTab === 0 && (
              <div className="flex-1 overflow-hidden">
                ...
                />
                {/* ✅ New Checkbox aligned right */}
                <div className="px-2 py-1 flex items-center justify-end gap-2">
                  <input
                    type="checkbox"
                    id="onlyRecipe"
                    checked={typeOption === "recipe"}
                    onChange={(e) =>
                      setTypeOption(e.target.checked ? "recipe" : "")
                    }
